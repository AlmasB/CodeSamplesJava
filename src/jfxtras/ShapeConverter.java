...
//        ExtensionFilter filterSVG = new ExtensionFilter("SVG image", "*.svg");
//
//        FileChooser fileChooser = new FileChooser();
//        fileChooser.setTitle("Save As...");
//        fileChooser.setInitialDirectory(new File("./"));
//        fileChooser.setInitialFileName("diagram");
//        fileChooser.getExtensionFilters().addAll(filterPNG, filterSVG);
//        fileChooser.setSelectedExtensionFilter(filterSVG);
...
//                writer.newLine();
//
//                for (Shape shape : renderer.shapes) {
//                    String svgPath = ShapeConverter.shapeToSvgString(shape);
//                    writer.write("<path d=\"" + svgPath + "\"/>");
//                    writer.newLine();
//                }
//
//                writer.write("</svg>");
